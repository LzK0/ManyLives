...
Route::post('/search_user_posts', [PostController::class, 'search_user_posts'])->name('search_user_posts')->middleware('auth');
Route::post('/search_users', [PostController::class, 'search_users'])->name('search_users')->middleware('auth');
Route::post('/dash_search', [PostController::class, 'dash_search'])->name('dash_search')->middleware('auth');
...
Route::get('/other_users', [PostController::class, 'other_users'])->name('other_users');
