...
<body class=" w-screen h-screen flex font-thin ">
    ...
    <nav id="sidebar" class="w-20 h-full bg-zinc-200 transition-all ease-linear duration-300 flex flex-col fixed z-10">
        ...
        <button class="absolute top-20 -right-3  text-sm bg-purple-600 hover:bg-purple-500 rounded-full px-1 transition-all ease-linear duration-300" id="sidebar-toggle"><i class="fa-solid fa-arrow-right"></i></button>
    </nav>
